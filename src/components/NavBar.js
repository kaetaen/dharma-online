...
function NavBar () {
    ...
    return (
        ...
        <div className="flex md:order-2">
            <button type="button" className="text-white bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0">Faça uma sugestão</button>
        ...
        <div  ref={navMobileRef} className=" items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
          <ul className="bg-emerald-500 flex flex-col p-4 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:border-gray-700">
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-white rounded hover:bg-red-600 md:hover:bg-transparent md:hover:text-red-300 md:p-0 ">Zen</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" className="block py-2 pl-3 pr-4 text-white rounded hover:bg-red-600 md:hover:bg-transparent md:hover:text-red-300 md:p-0 ">Tibetano</a>
            </li>
          </ul>
        </div>
        </div>
